...
public class ActivityMainListePatient extends AppCompatActivity implements DetecteurDeClicSurRecycler{
    ...
    private ArrayList<Patient> getDataSource(){
        ...
        liste.add(new Patient("Ait hadji","Aghilas",5,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Abdelouhab","Aimad",10,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolislknklnzgn lkzgnelknkg lflnklgf"));
        liste.add(new Patient("Ait hadji","Aghilas",5,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Abdelouhab","Aimad",10,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Ait hadji","Aghilas",5,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Abdelouhab","Aimad",10,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Ait hadji","Aghilas",5,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
        liste.add(new Patient("Abdelouhab","Aimad",10,076543,72873664,"a.aimad1999@gmail.com", "motdepasse","6 Rue Gaspard Coriolis"));
